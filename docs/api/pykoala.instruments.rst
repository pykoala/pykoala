...
The current version of PyKOALA requires users to previously process the raw data with `2dfdr <https://aat.anu.edu.au/science/instruments/current/AAOmega/reduction>`_.

.. automodule:: pykoala.instruments.koala_ifu
   :members:
   :undoc-members:
   :show-inheritance:

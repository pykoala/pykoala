...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep  3 12:22:53 2021
...
#import constants
#import "/DATA/KOALA/Python/pykoala_pablo_110921/pykoala/utils/constants.py"
...
class RSS(object):
    ...
    variance_corrected: np.array(float)
        Variance with all the correspondinf corrections applied.
    """
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# -----------------------------------------------------------------------------
    def do_extinction_curve(self, observatory_extinction_file="", fig_size=12,
        ...
        # Read data
        if observatory_extinction_file == "": 
            observatory_extinction_file = pykoala_path + 'input_data/observatory_extinction/ssoextinct.dat'

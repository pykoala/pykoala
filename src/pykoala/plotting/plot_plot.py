...
# -----------------------------------------------------------------------------
# -----------------------------------------------------------------------------
def plot_plot(x, y,  xmin=None,xmax=None,ymin=None,ymax=None,percentile_min=2, percentile_max=98,
              ...
              vlines=[], hlines=[], chlines=[], cvlines=[], axvspan=[[0,0]], caxvspan = [],
              hwidth =1, vwidth =1,
              ...
              save_file="", path="", fig_size=9, warnings = True, show=True, statistics=""):
   ...
   if axvspan[0][0] != 0:
       if len(axvspan) != len(caxvspan):
           for i in range(len(axvspan)-len(caxvspan)):
               caxvspan.append("orange") 

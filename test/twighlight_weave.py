...
from pykoala.instruments.weave import weave_rss

from pykoala.corrections import wavelength as wlc
...
reload(weave); rss = weave.weave_rss("../tutorials/data/weave/solar/msp_3059302.fit")

t0 = time()
reload(wlc); solar_correction = wlc.SolarCrossCorrOffset.from_fits()
shift, sigma = solar_correction.compute_shift_from_twilight(rss, keep_features_frac=0.05, logspace=False)
